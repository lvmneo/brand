...
<button
  ...
  className="cursor-pointer inline-flex items-center justify-center rounded-2xl border border-[#d8e4ff] bg-white px-5 py-3 font-semibold text-neutral-900 transition duration-200 hover:-translate-y-0.5 hover:bg-[#f4f8ff] active:scale-[0.98]"
>
  Отмена
</button>
          </div>
          ...
          >
            ...
            <div className="md:col-span-2 grid gap-4 rounded-2xl border border-[#d8e4ff] p-4">
              ...
              <button
                ...
                className=" cursor-pointer inline-flex items-center justify-center rounded-2xl bg-black px-5 py-3 font-semibold text-white shadow-[0_10px_24px_rgba(0,91,255,0.18)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(0,91,255,0.24)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
              >
