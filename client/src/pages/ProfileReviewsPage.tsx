      ...
      <section className="space-y-6">
        <div className="rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-black/[0.04] md:p-8">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <h1 className="text-5xl font-bold text-neutral-900">Мои отзывы</h1>
          ...
          {isLoading ? (
            ...
            <div className="mt-8 rounded-2xl border border-dashed p-8 text-slate-500">
            ...
            <div className="mt-8 space-y-4">
              {reviews.map((review) => (
                <div
                  key={review.id}
                  className="rounded-3xl border border-[#d7e3f8] bg-white p-5 shadow-sm"
                >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-5">
                        <Link
                          ...
                          className="inline-flex rounded-2xl bg-[#005bff] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#0047cc]"
                        >
                          Перейти к товару
                        </Link>
                      </div>
