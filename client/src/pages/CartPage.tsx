    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
      <div className="space-y-6">
        <section className="rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-black/[0.04] md:p-8">
          ...
          <div className="space-y-4">
            {items.map((item) => (
              <div
                key={item.id}
                className="flex flex-col gap-4 rounded-2xl border border-[#d7e3f8] bg-[#f8fbff] p-4 md:flex-row md:items-center"
              >
                <img
                ...
                <div className="font-bold md:w-28 md:text-right">
        ...
        <section className="rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-black/[0.04] md:p-8">
          ...
          {paymentMethod === 'CARD' && (
            <div className="mt-6 rounded-3xl bg-[#f8fbff] p-5">
              ...
              <button
                ...
                className="mt-5 rounded-2xl bg-[#005bff] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#0047cc] disabled:cursor-not-allowed disabled:opacity-60"
              >
          ...
          {paymentMethod === 'CASH' && (
            <div className="mt-6 rounded-3xl bg-[#f8fbff] p-5 text-sm text-slate-600">
